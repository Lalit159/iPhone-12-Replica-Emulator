$(function () {
  ...
  <div class="modo activo">Photo</div>
    ...
    function renderizarUI() {
        ...
        if ($('.wrapperApps .app[data-app="widgetFullCalendario"]').length) {
            ...
            $('.wrapperApps .app[data-app="widgetFullCalendario"] .icono').append(
                '<div class="eventos"><p>Without any more events for today</p></div><div class="calendarioWrapper"></div>'
            );
